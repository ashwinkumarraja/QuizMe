...
public class Scriptures3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scriptures3);
        String str = getIntent().getStringExtra("option");
        String str2 = getIntent().getStringExtra("Score");
        TextView scorem2 = findViewById(R.id.scores1);
        int z;
        if(str.equals("time's up")){
            scorem2.setText(str2);
        }
        else if(str.equals("Ganesh")){
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent i=new Intent(Scriptures3.this,Scriptures4.class);
                        TextView score = findViewById(R.id.scores1);
