...
public class Logos3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_logos3);
        ...
        else if(str.equals("Lamborghini")){
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent i=new Intent(Logos3.this,Logos4.class);
                        TextView score = findViewById(R.id.scorem1);
