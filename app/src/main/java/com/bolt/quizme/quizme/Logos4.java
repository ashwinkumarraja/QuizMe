...
public class Logos4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_logos4);
        ...
        if (str.equals("time's up")) {
            score.setText(str2);
        } else if (str.equals("Wolfsburg FC")) {
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent i = new Intent(Logos4.this, End.class);
                        TextView score = findViewById(R.id.scorem1);
