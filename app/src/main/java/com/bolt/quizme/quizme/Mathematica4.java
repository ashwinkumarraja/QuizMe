...
public class Mathematica4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mathematica4);
        ...
        final CountDownTimer myn = new CountDownTimer(10000, 1000) {
            ...
            public void onFinish() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        TextView scorem3 = findViewById(R.id.scorem3);
                        Intent i=new Intent(Mathematica4.this,End.class);
